...
import com.athar.bakeacademy.databinding.ActivityCameraBinding
...
class CameraActivity : AppCompatActivity() {
        ...
        imageCapture.takePicture(
            ...
            object : ImageCapture.OnImageSavedCallback {
                ...
                override fun onImageSaved(output: ImageCapture.OutputFileResults) {
                    ...
                    intent.putExtra("imageCameraTaken", output.savedUri)
                    intent.putExtra(
                        "isBackCamera",
    ...
    private val launcherIntentGallery = registerForActivityResult(
        ...
        if (result.resultCode == RESULT_OK) {
            ...
            val sendIntent = Intent(this@CameraActivity, CameraResultActivity::class.java)
            sendIntent.putExtra("image_gallery", selectedImg)

            setResult(CameraResultActivity.GALLERY_X_RESULT, sendIntent)
